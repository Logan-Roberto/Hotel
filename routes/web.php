...
Route::get('/alterar-funcionario', [FuncionarioController::class,'mostrarGerenciarFuncionarioId'])->name('mostrar-funcionario');
...
Route::get('/alterar-quarto/{id}', [QuartoController::class,'alterarQuartoBanco'])->name('alterar-quarto');
...
Route::get('/alterar-reserva', [ReservaController::class,'mostrarGerenciarReservaId'])->name('mostrar-reserva');
Route::get('/alterar-reserva/{id}', [ReservaController::class,'alterarReservaBanco'])->name('alterar-reserva');
